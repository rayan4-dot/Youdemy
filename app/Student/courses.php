...
<body class="bg-gray-50 flex">
    ...
    <div class="bg-green-600 text-white w-64 min-h-screen">
        ...
        <nav>
            <a href="student.php" class="block py-3 px-4 hover:bg-green-500">Enrolled Courses</a>
    ...
    <div class="flex-1">
        ...
        <header class="bg-white shadow-md py-4 px-6 flex justify-between items-center">
            <h1 class="text-xl font-bold">Welcome Back, Student</h1>
            <div class="flex items-center">
                <form method="POST" action="" class="flex items-center">
                    <input type="text" name="search" class="p-2 border border-gray-300 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Search by course title or category..." value="<?php echo htmlspecialchars($searchQuery); ?>">
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-400 ml-2">Search</button>
                </form>
                <a href="../Authentication/logout.php" class="bg-red-500 text-white py-2 px-4 rounded-lg ml-4">Logout</a>
            </div>
        </header>
